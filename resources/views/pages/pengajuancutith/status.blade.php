...
@section('title', 'Halaman Status Cuti Tahunan')
@section('statuscutith', 'active')
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Halaman Status Cuti Tahunan</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                            <li class="breadcrumb-item active">Halaman Status Cuti Tahunan</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            {{-- <div class="card-header">
                                <a class="btn btn-primary" href="#"><i class="fa fa-plus"></i> Ajukan Cuti Tahunan</a>
                            </div> --}}
                            <!-- /.card-header -->
                            <div class="card-body">
