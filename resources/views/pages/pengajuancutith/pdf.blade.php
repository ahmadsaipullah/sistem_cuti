...
<head>
    ...
    <title>Data Pengajuan Cuti Tahunan</title>
</head>
...
<body>
    ...
    <style type="text/css">
        ...
        .biodata td {
            ...
            padding: 4px;
            /* Penambahan padding untuk tampilan yang lebih baik */
        }
    ...
    <table class="header">
        <thead>
            <tr>
                ...
                <th>
                    <h2>PT UNION FOODS</h2>
                    <h4>Jl. Gatot Subroto Km 6.6 No.22, RT.005/RW.002, Jatake, Kec. Jatiuwung, Kota Tangerang, Banten
                        15136</h4>
                </th>
            </tr>
            <tr>
